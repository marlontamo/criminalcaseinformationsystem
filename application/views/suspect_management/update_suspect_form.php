...
<ol class='breadcrumb'>
	...
	<li><a href='".base_url()."index.php/suspect_update_controller/update_form/".$suspectNo."'><i class='glyphicon glyphicon-pencil'></i>Edit</a></li>
</ol>
</div>";

echo "<div class='well'>".form_open_multipart(base_url()."index.php/suspect_update_controller/update_suspect/$suspectNo");?>
	...
	<?php echo "<div class='pull-right'><img src='". base_url().'photo/'.$photo."' width='100px' height='100px' class='img-thumbnail' id='photo2'><br/>".$lastName.", ".$firstName." </div>";
	 $image = array( 'type' => 'file', 'name' => 'userfile' , 'value' => "<img src='". base_url().'photo/'.$photo."' width='100px' height='100px' class='img-thumbnail' id='photo2'>"
		);
