<div class='well'>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            echo form_upload('userfile');?><?php echo form_error('photo' ,'&nbsp<code class="btn-danger">', '</code>'); ?>
        </div>
    </div>
    <!--LAST NAME FIELD-->
    <div class="control-group">
        ...
        <div class='pull-right'>
            <div class="control-group">
                <div class="controls">
                    ...
                    <?php echo "<a title='Exit' class='btn btn-danger' href='".base_url()."index.php/suspect_view_controller/viewer/".$suspectNo."'>cancel</a>";?>
                </div>
            </div>
